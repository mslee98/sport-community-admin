...
import { fetchSiteWithInfo, addPromotion, updatePromotion, deletePromotion, updateSite, updateSiteInfo } from '../../services/site';
import type { Site, SiteDepositPromotion } from '../../types/site';
